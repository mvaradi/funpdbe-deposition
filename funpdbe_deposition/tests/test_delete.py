...
class ApiDeleteTests(TestCase):
    ...
    def test_deleting_without_login(self):
        response = self.client.delete("/funpdbe_deposition/entries/resource/cath-funsites/0x00/")
    ...
    def test_deleting_with_permission(self):
        self.generic_delete_test('/funpdbe_deposition/entries/resource/cath-funsites/0x00/', 301)
    ...
    def test_deleting_when_entry_is_not_there(self):
        self.generic_delete_test('/funpdbe_deposition/entries/resource/cath-funsites/0x42/', 404)
    ...
    def test_deleting_when_pdb_id_is_invalid(self):
        self.generic_delete_test('/funpdbe_deposition/entries/resource/cath-funsites/9999/', 400)